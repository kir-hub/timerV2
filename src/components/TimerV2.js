...
export default function TimerV2(props) {
    ...
    const calculateTimer = ()=>{
        ...
        const min = (timer.h == 0 && timer.m == 0) ? 0 : ((timer.h > 0 && timer.m == 0 ) ? 5 : (timer.m > 0 && timer.s == 0 ? timer.m - 1 : timer.m )) //timer.m - 1)  && timer.m == 0  && timer.s == 0) ? 5 : timer.m ) ? timer.m - 1  //(( ((sec == 0 && timer.h > 0) && 5) ?  timer.m - 1 : timer.m))
